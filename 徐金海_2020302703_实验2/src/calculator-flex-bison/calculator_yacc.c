...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_MUL = 5,                      /* T_MUL  */
  YYSYMBOL_T_ADD = 6,                      /* T_ADD  */
  YYSYMBOL_T_LPAREN = 7,                   /* T_LPAREN  */
  YYSYMBOL_T_RPAREN = 8,                   /* T_RPAREN  */
...
{
       0,    48,    48,    53,    58,    66,    83,    91,   100,   107,
     113,   120,   126,   131,   142
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_MUL", "T_ADD", "T_LPAREN", "T_RPAREN", "T_ASSIGN", "T_SEMICOLON",
  "$accept", "Input", "Block", "Statement", "Expr", "Term", "Factor", YY_NULLPTR
};
...
{
       0,    13,    14,     0,     0,     2,     3,     7,     9,    11,
       0,    14,     0,     1,     4,     0,     6,     0,     0,    12,
       8,    10,     5
};
...
{
      12,     1,     2,    10,    13,     3,    15,    18,     1,    11,
      16,    17,     3,    15,    15,    14,    19,    22,    20,    21
};

static const yytype_int8 yycheck[] =
{
       3,     3,     4,     9,     0,     7,     6,    10,     3,     4,
      10,     5,     7,     6,     6,     5,     8,    10,    15,    17
};
...
{
       0,     3,     4,     7,    12,    13,    14,    15,    16,    17,
       9,     4,    15,     0,    14,     6,    10,     5,    15,     8,
      16,    17,    10
};
...
#line 1180 "calculator_yacc.c"
    break;

  case 10: /* Term: Term T_MUL Factor  */
#line 114 "calculator.y"
            {
                /* Term = Term * Factor */
...
#line 1191 "calculator_yacc.c"
    break;

  case 11: /* Term: Factor  */
#line 121 "calculator.y"
            {
                /* Term = Factor */
                (yyval.node) = (yyvsp[0].node);
            }
#line 1200 "calculator_yacc.c"
    break;

  case 12: /* Factor: T_LPAREN Expr T_RPAREN  */
#line 127 "calculator.y"
            {
                /* Factor = Expr */
                (yyval.node) = (yyvsp[-1].node);
            }
#line 1209 "calculator_yacc.c"
    break;

  case 13: /* Factor: T_DIGIT  */
#line 132 "calculator.y"
            {
                // 终结符作为抽象语法树的叶子节点进行创建
...
#line 1224 "calculator_yacc.c"
    break;

  case 14: /* Factor: T_ID  */
#line 142 "calculator.y"
              {
                struct ast_node_attr temp_val;
                temp_val.kind = DIGIT_KIND_ID;
...
#line 1237 "calculator_yacc.c"
    break;


#line 1241 "calculator_yacc.c"
